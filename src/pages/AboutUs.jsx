  ...
  return (
    <div className="my-container text-center mt-8">
      ...
      <p className="font-semibold text-xl mb-12">
        ...
        looks great on each face! We simply need to be in charge of something
        like one of your sweet grins! Indeed, even our slogan ‘delights for all’
        pass on the equivalent, and we plan to accomplish this by offering toys
        for all, with the goal that the initial 100 years of your adolescence
        are praised without bounds. ‘Playful Delights’ Innovations, a web-based
        shopping gateway, is a selective and definitive goal for a wide range of
        toys. With a profound want to contact each heart and achieve each home
        in America, we have right now dedicated every one of our assets to take
        into account the American market. Established by a gathering of
        energetic visionaries, ‘Playful Delights’ is altogether equipped to set
        new benchmarks in the toy business and has plans to be the main
        ‘pioneer’ in not so distant future. With experts of the exchange locally
        available, we work to comprehend the brain research and the need of each
        being so as to convey the correct toy in the correct hands!
      </p>
      <p className="font-semibold text-xl mb-12">
        ...
        experience to you. When you shop from our store, you will positively
        return for additional.
      </p>
      <p className="text-end">Glad to have you with us!</p>
    </div>
  );
};
