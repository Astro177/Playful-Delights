  ...
  return (
    <div className="my-container">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 justify-center items-center gap-24 mb-24">
        ...
        <div>
          <p className="w-32 h-32 bg-green-600 rounded-full text-center text-5xl font-bold text-slate-300 mb-6">2</p>
          <p className="text-lg font-semibold text-pink-500 mb-2">Customization</p>
          <p>You can customize your own toy just the way you like it</p>
        </div>
        <div>
          <p className="w-32 h-32 bg-yellow-600 rounded-full text-center text-5xl font-bold text-slate-300 mb-6">3</p>
          <p className="text-lg font-semibold text-pink-500 mb-2">Fast Delivery</p>
